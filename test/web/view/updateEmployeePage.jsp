...
<form action=${pageContext.request.contextPath}/employeeController?idEmployee=${requestScope.employee.idEmployee}&idDepartment=${requestScope.employee.idDepartment}
      method="post">
    <p><label>
